//Do not translate text here! Add section for new language below.
...
var TDistanceSumM = 'Total monthly distance';
var TDistanceSumW = 'Total weekly distance';
var TDistanceAvg = 'Average daily distance, meters';
var TStepsSumM = 'Total monthly steps';
var TStepsSumW = 'Total weekly steps';
var TStepsAvg = 'Average daily steps';
var TDailyGoals = 'Daily goals';
var TGoalSleep = 'Sleep';
var TGoalSteps = 'Steps';

var TAggregate = 'Aggregate data by';
var TAggregateDay = 'day';
var TAggregateWeek = 'week';
var TAggregateMonth = 'month';
...
data.addColumn('date',Tdate, 'date');
data.addColumn('number',Tyear, 'year');
data.addColumn('string',Tyearmonth ,  'yearmonth');
data.addColumn('number',Tmonth,  'month');
data.addColumn('string',Tyearweek,  'yearweek');
data.addColumn('number',Tweek,  'week');
data.addColumn('number',Tdayofweek,  'dayofweek');
data.addColumn('number',Tday,  'day');
data.addColumn('number',TInBedMin,  'InBedMin');
data.addColumn('number',TDeepSleepMin,  'DeepSleepMin');
data.addColumn('number',TLightSleepMin,  'LightSleepMin');
data.addColumn('number',TAwakeMin,  'AwakeMin');
data.addColumn('number',TDailyDistanceMeter,  'DailyDistanceMeter');
data.addColumn('number',TDailySteps,  'DailySteps');
data.addColumn('number',TDailyBurnCalories,  'DailyBurnCalories');
data.addColumn('number',TWalkDistance,  'WalkDistance');
data.addColumn('number',TWalkTimeMin,  'WalkTimeMin');
data.addColumn('number',TWalkBurnCalories,  'WalkBurnCalories');
data.addColumn('number',TRunDistanceMeter,  'RunDistanceMeter');
data.addColumn('number',TRunTimeMin,  'RunTimeMin');
data.addColumn('number',TRunBurnCalories,  'RunBurnCalories');
data.addColumn('date',TSleepStartOffset, 'SleepStartOffset');
data.addColumn('date',TSleepEndOffset, 'SleepEndOffset');
