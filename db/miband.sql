...
.mode csv
.output extract.csv
select strftime('%Y-%m-%d',Date) || " " as Date,LightSleepMin+DeepSleepMin as InBedMin
    ,DeepSleepMin, LightSleepMin, SleepStart, SleepEnd, AwakeMin
...
select
	...
	strftime('%Y',Date) ||
	"," ||
	cast((cast(strftime('%m',Date) as integer)-1) as text) ||
	"," ||
	strftime('%d',Date) ||
	")," ||
	strftime('%Y',Date) ||
	...
	strftime('%d',Date) ||
	"," ||
	cast(LightSleepMin+DeepSleepMin as text) ||
	"," ||
	cast(DeepSleepMin as text) ||
	"," ||
	cast(LightSleepMin as text) ||
	"," ||
	cast(AwakeMin as text) ||
	"," ||
	cast(DailyDistanceMeter as text) ||
	"," ||
	cast(DailySteps as text) ||
	"," ||
	cast(DailyBurnCalories as text) ||
	"," ||
	cast(DailyDistanceMeter-RunDistanceMeter as text) ||
	"," ||
	cast(WalkTimeMin as text) ||
	"," ||
	cast(DailyBurnCalories-RunBurnCalories as text) ||
	"," ||
	cast(RunDistanceMeter as text) ||
	"," ||
	cast(RunTimeMin as text) ||
	"," ||
	cast(RunBurnCalories as text) ||
	"," ||
	--cast(720+(SleepStart-strftime('%s',date))/60 as text)||","||cast((SleepEnd-SleepStart)/60 as text)
	"new Date(0,0," ||
	case when SleepStart < Date then "-1" else "0" end ||
	"," ||
	strftime('%H',SleepStart) ||
	"," ||
	strftime('%M',SleepStart) ||
	"," ||
	strftime('%S',SleepStart) ||
	")," ||
	"new Date(0,0," ||
	case when SleepEnd < Date then "-1" else "0" end ||
	"," ||
	strftime('%H',SleepEnd) ||
	"," ||
	strftime('%M',SleepEnd) ||
